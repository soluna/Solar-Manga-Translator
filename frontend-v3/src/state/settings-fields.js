...
export const ADVANCED_ERASE_PROVIDERS = choices([
  ['volcengine-ark', '火山引擎 Ark / Seedream'],
])
...
export const SETTINGS_FIELDS = {
  ...
  advanced_erase_provider: { label: 'Provider', options: ADVANCED_ERASE_PROVIDERS },
...
export const SETTINGS_GROUPS = [
  ...
  { id: 'cleanup', label: '图像清理与擦除', keys: ['image_cleanup_mode', 'image_cleanup_model', 'image_cleanup_api_key', 'advanced_erase_provider', 'advanced_erase_base_url', 'advanced_erase_model', 'advanced_erase_api_key', 'advanced_erase_timeout_seconds', 'advanced_erase_selection_prompt', 'export_mask_debug'] },
  { id: 'fonts', label: '字体' }, { id: 'advanced', label: '高级' },
]

export function fontSourceLabel(source) {
  return ({ system: '内置', custom: '自定义', project: '自定义', user: '自定义', bundled: '内置' })[source] || source || '未知'
}
