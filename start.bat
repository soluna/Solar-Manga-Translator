...
if not defined APP_LEGACY_TEMP_DIRS set "APP_LEGACY_TEMP_DIRS=%TEMP%;%TMP%"
set "APP_DATA_DIR=%APP_DATA_ROOT%"
set "APP_MODELS_DIR=%APP_DATA_ROOT%\models"
set "APP_OUTPUT_DIR=%APP_DATA_ROOT%\output"
set "APP_LOG_DIR=%APP_DATA_ROOT%\logs"
set "APP_CACHE_DIR=%APP_DATA_ROOT%\cache"
set "APP_TEMP_DIR=%APP_DATA_ROOT%\temp"
set "APP_FONT_DIR=%APP_DATA_ROOT%\fonts"
set "TEMP=%APP_TEMP_DIR%"
set "TMP=%APP_TEMP_DIR%"
set "TMPDIR=%APP_TEMP_DIR%"
set "XDG_CACHE_HOME=%APP_CACHE_DIR%\external"
set "HF_HOME=%APP_CACHE_DIR%\huggingface"
...
set "TORCH_HOME=%APP_CACHE_DIR%\torch"
set "TORCH_EXTENSIONS_DIR=%TORCH_HOME%\extensions"
set "TORCHINDUCTOR_CACHE_DIR=%TORCH_HOME%\inductor"
set "TRITON_CACHE_DIR=%APP_CACHE_DIR%\triton"
set "MPLCONFIGDIR=%APP_CACHE_DIR%\matplotlib"
set "NUMBA_CACHE_DIR=%APP_CACHE_DIR%\numba"
set "CUDA_CACHE_PATH=%APP_CACHE_DIR%\cuda"
set "PYTHONPYCACHEPREFIX=%APP_CACHE_DIR%\python-bytecode"
set "PIP_CACHE_DIR=%APP_CACHE_DIR%\pip"
set "npm_config_cache=%APP_CACHE_DIR%\npm"
set "ELECTRON_CACHE=%APP_CACHE_DIR%\electron-downloads"
set "ELECTRON_BUILDER_CACHE=%APP_CACHE_DIR%\electron-builder"
if not exist "%APP_TEMP_DIR%" mkdir "%APP_TEMP_DIR%"
if not exist "%APP_CACHE_DIR%" mkdir "%APP_CACHE_DIR%"
